...
cp "${ROOT_DIR}/ci/release/templates/winlator-v0.9c.ru-en.md" "${OUT_DIR}/winlator-v0.9c.md"
...
printf '[release-notes] Wrote %s and %s\n' "${OUT_DIR}/winlator-v0.9c.md" "${OUT_DIR}/wcp-stable.md"
