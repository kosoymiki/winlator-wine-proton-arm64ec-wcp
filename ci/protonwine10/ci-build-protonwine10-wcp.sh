...
: "${WINE_TOOLS_CONFIGURE_EXTRA_ARGS:=--without-gstreamer --without-vulkan --without-wayland}"
: "${WINE_CONFIGURE_EXTRA_ARGS:=--without-fontconfig --without-gstreamer --without-vulkan --without-wayland}"
