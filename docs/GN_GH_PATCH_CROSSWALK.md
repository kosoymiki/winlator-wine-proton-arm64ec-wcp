...
1. `0044`: launch pipeline merge (GN+GH) under URC with reason-coded forensics.
2. `0045`: graphics/driver decision merge with deterministic fallback chain.
3. `0046`: registry/runtime guarded deltas only (no asset-first side effects).
