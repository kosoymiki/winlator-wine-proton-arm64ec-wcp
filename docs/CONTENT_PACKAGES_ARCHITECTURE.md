...
- Package assets: GitHub Releases of this repository (`wcp-v0.2b` + per-package rolling `*-latest` tags)
...
- `releaseTag`: release source (`wcp-v0.2b` or per-package rolling tag like `wine-11-arm64ec-latest`)
