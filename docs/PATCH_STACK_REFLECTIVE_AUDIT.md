...
Generated: `2026-02-27T01:31:04Z`

## Snapshot

- Patch count: `64`
- Unique touched source files: `66`
- Diff volume across stack: `+16282 / -3026`
- Mean files touched per patch: `3.56`
...
- `app/src/main/java/com/winlator/cmod/XServerDisplayActivity.java` touched by `21` patches
...
- `app/src/main/java/com/winlator/cmod/AdrenotoolsFragment.java` touched by `13` patches
...
- `app/src/main/java/com/winlator/cmod/container/Container.java` touched by `11` patches
...
- `app/src/main/res/values/arrays.xml` touched by `5` patches
  - `0001-winlator-arm64ec-runtime-and-fex.patch`, `0026-upscale-container-bridge-launch-normalization-and-ui.patch`, `0049-upscale-eden-render-controls-and-runtime-contract.patch`, `0050-upscale-eden-advanced-renderer-runtime-controls.patch`, `0064-vulkan-1-4-policy-and-negotiation.patch`
...
- `critical` (9 files):
  - `app/src/main/java/com/winlator/cmod/XServerDisplayActivity.java` (21 patches)
  ...
  - `app/src/main/java/com/winlator/cmod/AdrenotoolsFragment.java` (13 patches)
  - `app/src/main/java/com/winlator/cmod/ContainerDetailFragment.java` (12 patches)
  - `app/src/main/java/com/winlator/cmod/container/Container.java` (11 patches)
...
- `medium` (12 files):
  ...
  - `app/src/main/res/values/arrays.xml` (5 patches)
...
- `app/src/main/java/com/winlator/cmod/XServerDisplayActivity.java` -> touched: `yes` (21 patches)
- `app/src/main/java/com/winlator/cmod/xenvironment/components/GuestProgramLauncherComponent.java` -> touched: `yes` (20 patches)
- `app/src/main/java/com/winlator/cmod/container/Container.java` -> touched: `yes` (11 patches)
...
- `app/src/main/java/com/winlator/cmod/AdrenotoolsFragment.java` -> touched: `yes` (13 patches)
